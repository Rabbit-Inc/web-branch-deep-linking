...
// Input 2
var config = {app_service_endpoint:"https://app-link.rabb.it", link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api-link.rabb.it", version:"2.27.1"};
// Input 3
...
Server.prototype.jsonpRequest = function(a, b, c, d) {
  var e = "branch_callback__" + this._jsonp_callback_index++, f = 0 <= a.indexOf("branch.io") || 0 <= a.indexOf("api-link.rabb.it") ? "&data=" : "&post_data=";
